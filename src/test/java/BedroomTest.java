...
public class BedroomTest {
    ...
    @Before
    public void before(){
        bedroom = new Bedroom(1, BedroomType.DOUBLE, 50.00);
    ...
    public void canGetRate(){
        assertEquals(50.00, bedroom.getRate(), 0);
    }

    @Test
    public void canGetTotalBillForBedroomBooking(){
        Booking booking = new Booking(bedroom, 4);
        assertEquals(200.00, bedroom.getTotalBill(booking), 0);
    }
}
